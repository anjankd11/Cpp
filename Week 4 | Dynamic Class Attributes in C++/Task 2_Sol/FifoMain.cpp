...
int main(void)
{
	...
	// Insert is tested
	s1.push(1);
	s1.push(1);  // Inserting a duplicated element, the total number of elements should not change at this line
	s1.push(2);
	s1.print();
	...
	cout<< "Poping "<< s2.pop();	// Testing remove method
	...
	//s2.pop();	// Further testing of remove method: make sure that false is returned. Use debugger.
	return 0;
}
